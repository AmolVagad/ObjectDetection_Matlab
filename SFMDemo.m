...
% Add the first view. Place the camera associatedwith the first view
...
camPoses = poses(vSet);
figure;
plotCamera('location',camPoses, 'Size', 0.2);
hold on
...
% Display the dense reconstruction 
